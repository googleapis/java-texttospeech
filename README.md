...
```Groovy
implementation 'com.google.cloud:google-cloud-texttospeech:2.0.3'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-texttospeech" % "2.0.3"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-texttospeech/tree/master/samples) directory.
