...
[google-cloud-java/java-texttospeech](
https://github.com/googleapis/google-cloud-java/tree/main/java-texttospeech).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-texttospeech`) remain the same.
...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-texttospeech" % "2.13.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-texttospeech/2.13.0
