...
private static final long serialVersionUID = 0L;
  ...
  public enum TimepointType
    ...
    public static TimepointType forNumber(int value) {
      switch (value) {
        case 0: return TIMEPOINT_TYPE_UNSPECIFIED;
        case 1: return SSML_MARK;
        default: return null;
      }
    }

    public static com.google.protobuf.Internal.EnumLiteMap<TimepointType>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static final com.google.protobuf.Internal.EnumLiteMap<
        TimepointType> internalValueMap =
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.getDescriptor().getEnumTypes().get(0);
    }

    private static final TimepointType[] VALUES = values();

    public static TimepointType valueOf(
   ...
   */
  @java.lang.Override
  public java.util.List<com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType> getEnableTimePointingList() {
    return new com.google.protobuf.Internal.ListAdapter<
        java.lang.Integer, com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType>(enableTimePointing_, enableTimePointing_converter_);
  }
  /**
   * <pre>
   * Whether and what timepoints are returned in the response.
   ...
   */
  @java.lang.Override
  public com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType getEnableTimePointing(int index) {
    ...
    }
    {
      ...
      for (int i = 0; i < enableTimePointing_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream
          .computeEnumSizeNoTag(enableTimePointing_.get(i));
      }
      size += dataSize;
      if (!getEnableTimePointingList().isEmpty()) {  size += 1;
        size += com.google.protobuf.CodedOutputStream
  ...
  public static final class Builder extends
    ...
    public Builder setEnableTimePointing(
        int index, com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureEnableTimePointingIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addEnableTimePointing(com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureEnableTimePointingIsMutable();
    ...
    public Builder addAllEnableTimePointing(
        java.lang.Iterable<? extends com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType> values) {
      ensureEnableTimePointingIsMutable();
      for (com.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType value : values) {
        enableTimePointing_.add(value.getNumber());
      }
      onChanged();
      return this;
     ...
     * @return This builder for chaining.
     */
    public Builder setEnableTimePointingValue(
        int index, int value) {
      ensureEnableTimePointingIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllEnableTimePointingValue(
